...
and 2) to setup the whole project. The aim of the package `rcompendium` is to 
make easier the creation of R package/research compendium (i.e. a predefined 
files/folders structure) so that user can focus on the code/analysis instead of 
...
:boom: This package [pkgtest](https://github.com/ahasverus/pkgtest) was created by running:

```{r eval = FALSE}
rcompendium::new_package()
```

:boom: This [research compendium](https://github.com/ahasverus/comptest) was created by running:
...
compendium structure. Version 0.5, https://github.com/FRBCesab/rcompendium.
