...
:boom: The repository [pkgtest](https://github.com/ahasverus/pkgtest) was created by running:
...
**N.B.** Before running this command, a new RStudio project (called `pkgtest`) was manually created.
