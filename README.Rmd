...
:boom: This [package](https://github.com/ahasverus/rpackage) was created by running:

```{r eval = FALSE}
rcompendium::new_package()
```

:boom: This [research compendium](https://github.com/ahasverus/rcompendium) was created by running:
