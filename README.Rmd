...
:boom: This [package](https://github.com/ahasverus/demo.package) was set up by running:

```{r eval = FALSE}
rcompendium::new_package()
```

:boom: This [research compendium](https://github.com/ahasverus/demo.compendium) was set up by running:
