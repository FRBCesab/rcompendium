...
a lot a projects (package and/or compendium) it can be frustrating in the 
long run.
...
**N.B.** User can also use functions from the package [`usethis`](https://usethis.r-lib.org/)
